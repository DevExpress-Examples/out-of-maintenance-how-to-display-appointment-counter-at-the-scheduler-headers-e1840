Namespace WindowsApplication47
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            ' schedulerControl1
            ' 
            Me.schedulerControl1.Appearance.AlternateHeaderCaption.BackColor = System.Drawing.Color.FromArgb((CInt((CByte(224)))), (CInt((CByte(224)))), (CInt((CByte(224)))))
            ...
            Me.schedulerControl1.Start = New Date(2009, 11, 12, 0, 0, 0, 0)
